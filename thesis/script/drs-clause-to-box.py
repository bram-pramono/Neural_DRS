...
if __name__ == '__main__':
  ...
  target_scrape_folder = to_abspath(base_folder, "thesis/data/manually_annotated_data", today)
  prev_scrape_folder = to_abspath(base_folder, "thesis/data/manually_annotated_data/latest")
  ...
  flush_clean_wrap_print(to_abspath(base_folder, f'thesis/report-clean-up-data_{today}.txt'))
